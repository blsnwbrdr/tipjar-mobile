...
export default class CalculatorScreen extends Component {
  ...
  onPressPercentButton(percent) {
    ...
    if (this.state.percentPressed === false) {
      ...
      let percentValue =
        Math.round(this.state.inputValue * percent * 100) / 100;
      this.setState({
        inputValue: percentValue,
      });
    } else {
      let percentValue =
        Math.round(this.state.previousInputValue * percent * 100) / 100;
      this.setState({
        inputValue: percentValue,
      });
    }
    ...
    return (
      <SafeAreaView style={CalculatorStyles.container}>
        ...
        <View style={CalculatorStyles.displayContainer}>
          <Text style={CalculatorStyles.displayText}>
        ...
        <View style={CalculatorStyles.calcPad}>
          <View style={CalculatorStyles.percentRow}>
            <TouchableHighlight
              ...
              underlayColor='white'
              onPress={() => this.onPressPercentButton(0.05)}
            >
            ...
            <TouchableHighlight
              style={CalculatorStyles.calcPercentButton}
              underlayColor='white'
              onPress={() => this.onPressPercentButton(0.1)}
            >
            ...
            <TouchableHighlight
              style={CalculatorStyles.calcPercentButton}
              underlayColor='white'
              onPress={() => this.onPressPercentButton(0.15)}
            >
            ...
            <TouchableHighlight
              style={CalculatorStyles.calcPercentButton}
              underlayColor='white'
              onPress={() => this.onPressPercentButton(0.2)}
            >
